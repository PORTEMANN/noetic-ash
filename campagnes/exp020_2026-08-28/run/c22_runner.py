#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""C22 — campagne exp020 : micro-rythme de la résurgence E44, graines
aveugles 2033+2034 (attente EXP-020, figée AVANT mesure,
bridge/expectations.json v1.2.0, commit 3d9efe8).

Régénère les graines 2033 et 2034 (reprise exacte du volet a de
c14_runner.py : e44_core.py, SeedSequence(2033/2034), N=48, A=1, gamma=0.2,
...
Produit (octets déterministes, fins de ligne LF) :
  signaux/e44_nv_t_g2033.csv, signaux/e44_lt_t_g2033.csv
  signaux/e44_nv_t_g2034.csv, signaux/e44_lt_t_g2034.csv
  run/manifest_signaux.json

Usage : python3 run/c22_runner.py   (depuis la racine de la campagne)
"""
...
for g in (2033, 2034):
    ...
    print(f"[C22] graine {g} : sha256 tableaux nus = "
...
print(f"[C22] manifest_signaux.json : {len(man)} empreintes")
